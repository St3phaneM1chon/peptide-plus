  ...
  const categories = [
    {
      name: 'Podcast',
      slug: 'podcast',
      description: 'Audio and video podcast episodes',
      icon: 'podcast',
      sortOrder: 1,
    },
    {
    ...
    },
    {
      ...
      description: 'One-on-one client sessions',
      icon: 'user',
      sortOrder: 3,
    },
    {
    ...
    },
    {
      name: 'FAQ Video',
      slug: 'faq-video',
      description: 'Video answers to frequently asked questions',
      icon: 'help-circle',
      sortOrder: 6,
    },
    {
    ...
    },
    {
      name: 'Recherche',
      slug: 'recherche',
      description: 'Research updates and scientific content',
      icon: 'microscope',
      sortOrder: 10,
    },
  ];
