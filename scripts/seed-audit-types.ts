/**
 * Seed script for 39 Audit Types (27 original + 12 section audits)
...
const auditTypes: AuditTypeSeed[] = [
  ...
  // ============== SECTION AUDITS (28-39) ==============
  {
    code: 'SECTION-DASHBOARD',
    name: 'Dashboard Section Audit',
    nameFr: 'Audit Section Tableau de Bord',
    description: '8-angle audit of admin dashboard: DB, component matrix, API, UI, states, interactions, responsive, accessibility',
    descriptionFr: 'Audit 8 angles du tableau de bord admin: BD, matrice composants, API, UI, etats, interactions, responsive, accessibilite',
    severity: 'HIGH',
    category: 'section',
    sortOrder: 28,
    checklist: [
      { id: 'sec-dash-db-01', check: 'Prisma models exist for dashboard data', description: 'Order, User, Product models exist' },
      { id: 'sec-dash-matrix-01', check: 'Dashboard page exists', description: '/admin/dashboard page.tsx present' },
      { id: 'sec-dash-api-01', check: 'Dashboard API has auth', description: '/api/admin/dashboard protected by auth()' },
      { id: 'sec-dash-ui-01', check: 'Dashboard loads without errors', description: 'No console/network errors on load' },
      { id: 'sec-dash-state-01', check: 'Loading state handled', description: 'Skeleton/spinner shown while loading' },
      { id: 'sec-dash-interact-01', check: 'Stats cards are interactive', description: 'Cards link to detail pages' },
      { id: 'sec-dash-responsive-01', check: 'Responsive layout', description: 'Works on mobile 375px and tablet 768px' },
      { id: 'sec-dash-a11y-01', check: 'ARIA attributes present', description: 'Screen reader compatible' },
    ],
  },
  {
    code: 'SECTION-COMMERCE',
    name: 'Commerce Section Audit',
    nameFr: 'Audit Section Commerce',
    description: '8-angle audit of commerce pages: orders, customers, subscriptions, inventory, suppliers',
    descriptionFr: 'Audit 8 angles des pages commerce: commandes, clients, abonnements, inventaire, fournisseurs',
    severity: 'CRITICAL',
    category: 'section',
    sortOrder: 29,
    checklist: [
      { id: 'sec-com-db-01', check: 'Commerce models exist', description: 'Order, User, Company, Subscription, Product models' },
      { id: 'sec-com-matrix-01', check: 'All commerce pages exist', description: 'commandes, customers, clients, abonnements, inventaire, fournisseurs' },
      { id: 'sec-com-api-01', check: 'Commerce APIs protected', description: 'All /api/admin/commandes etc. have auth guards' },
      { id: 'sec-com-ui-01', check: 'Pages load cleanly', description: 'No console errors across commerce pages' },
      { id: 'sec-com-state-01', check: 'Empty/loading/error states', description: 'All commerce pages handle empty data and errors' },
      { id: 'sec-com-interact-01', check: 'CRUD operations work', description: 'Create, edit, delete orders/customers functional' },
      { id: 'sec-com-responsive-01', check: 'Tables scroll on mobile', description: 'Data tables have overflow-x-auto' },
      { id: 'sec-com-a11y-01', check: 'Form labels present', description: 'All form fields have associated labels' },
    ],
  },
  {
    code: 'SECTION-CATALOG',
    name: 'Catalog Section Audit',
    nameFr: 'Audit Section Catalogue',
    description: '8-angle audit of catalog: products, categories',
    descriptionFr: 'Audit 8 angles du catalogue: produits, categories',
    severity: 'HIGH',
    category: 'section',
    sortOrder: 30,
    checklist: [
      { id: 'sec-cat-db-01', check: 'Product/Category models with translations', description: 'Product, Category, ProductTranslation, CategoryTranslation' },
      { id: 'sec-cat-matrix-01', check: 'Catalog pages exist', description: '/admin/produits and /admin/categories' },
      { id: 'sec-cat-api-01', check: 'Catalog APIs protected and validated', description: 'Auth + Zod on product/category routes' },
      { id: 'sec-cat-ui-01', check: 'Product grid/list displays', description: 'Products shown with images and prices' },
      { id: 'sec-cat-state-01', check: 'Search and filter functional', description: 'Category filter and product search work' },
      { id: 'sec-cat-interact-01', check: 'Product CRUD works', description: 'Create, edit, delete products functional' },
      { id: 'sec-cat-responsive-01', check: 'Grid adapts to screen size', description: 'Product grid columns reduce on mobile' },
      { id: 'sec-cat-a11y-01', check: 'Product images have alt text', description: 'All product images have meaningful alt' },
    ],
  },
  {
    code: 'SECTION-MARKETING',
    name: 'Marketing Section Audit',
    nameFr: 'Audit Section Marketing',
    description: '8-angle audit of marketing: promo codes, promotions, newsletter, banners, upsell',
    descriptionFr: 'Audit 8 angles du marketing: codes promo, promotions, infolettre, bannieres, ventes suggerees',
    severity: 'MEDIUM',
    category: 'section',
    sortOrder: 31,
    checklist: [
      { id: 'sec-mkt-db-01', check: 'Marketing models exist', description: 'PromoCode, Promotion, NewsletterCampaign, Banner, UpsellRule' },
      { id: 'sec-mkt-matrix-01', check: 'Marketing pages exist', description: 'promo-codes, promotions, newsletter, bannieres, upsell pages' },
      { id: 'sec-mkt-api-01', check: 'Marketing APIs protected', description: 'Auth guards on all marketing routes' },
      { id: 'sec-mkt-ui-01', check: 'Pages load without errors', description: 'No console errors on marketing pages' },
      { id: 'sec-mkt-state-01', check: 'Empty states handled', description: 'Friendly message when no promo codes etc.' },
      { id: 'sec-mkt-interact-01', check: 'Create promo code flow works', description: 'Form to create/edit promo codes functional' },
      { id: 'sec-mkt-responsive-01', check: 'Responsive layout', description: 'Tables and forms adapt to mobile' },
      { id: 'sec-mkt-a11y-01', check: 'Form accessibility', description: 'Labels and ARIA on form inputs' },
    ],
  },
  {
    code: 'SECTION-COMMUNITY',
    name: 'Community Section Audit',
    nameFr: 'Audit Section Communaute',
    description: '8-angle audit of community: reviews, questions, chat, ambassadors',
    descriptionFr: 'Audit 8 angles de la communaute: avis, questions, chat, ambassadeurs',
    severity: 'LOW',
    category: 'section',
    sortOrder: 32,
    checklist: [
      { id: 'sec-comm-db-01', check: 'Community models exist', description: 'Review, ProductQuestion, ChatMessage, Ambassador' },
      { id: 'sec-comm-matrix-01', check: 'Community pages exist', description: 'avis, questions, chat, ambassadeurs pages' },
      { id: 'sec-comm-api-01', check: 'Community APIs protected', description: 'Auth guards on community routes' },
      { id: 'sec-comm-ui-01', check: 'Pages load without errors', description: 'No console errors' },
      { id: 'sec-comm-state-01', check: 'Empty states handled', description: 'Message when no reviews/questions' },
      { id: 'sec-comm-interact-01', check: 'Moderation actions work', description: 'Approve/reject reviews functional' },
      { id: 'sec-comm-responsive-01', check: 'Responsive layout', description: 'Review cards stack on mobile' },
      { id: 'sec-comm-a11y-01', check: 'Chat accessible', description: 'Chat input has labels, messages have roles' },
    ],
  },
  {
    code: 'SECTION-LOYALTY',
    name: 'Loyalty Section Audit',
    nameFr: 'Audit Section Fidelite',
    description: '8-angle audit of loyalty: members, transactions, webinars',
    descriptionFr: 'Audit 8 angles de la fidelite: membres, transactions, webinaires',
    severity: 'MEDIUM',
    category: 'section',
    sortOrder: 33,
    checklist: [
      { id: 'sec-loy-db-01', check: 'Loyalty models exist', description: 'LoyaltyMember, LoyaltyTransaction, Webinar' },
      { id: 'sec-loy-matrix-01', check: 'Loyalty pages exist', description: 'fidelite and webinaires pages' },
      { id: 'sec-loy-api-01', check: 'Loyalty APIs protected', description: 'Auth on loyalty routes' },
      { id: 'sec-loy-ui-01', check: 'Member list displays', description: 'Loyalty members shown with points' },
      { id: 'sec-loy-state-01', check: 'Empty state for new program', description: 'Onboarding message when 0 members' },
      { id: 'sec-loy-interact-01', check: 'Add/adjust points works', description: 'Point adjustment form functional' },
      { id: 'sec-loy-responsive-01', check: 'Responsive layout', description: 'Tables adapt to mobile' },
      { id: 'sec-loy-a11y-01', check: 'Accessible forms', description: 'Point adjustment form has labels' },
    ],
  },
  {
    code: 'SECTION-MEDIA',
    name: 'Media Section Audit',
    nameFr: 'Audit Section Media',
    description: '8-angle audit of media library: upload, browse, metadata',
    descriptionFr: 'Audit 8 angles de la mediatheque: telechargement, navigation, metadonnees',
    severity: 'MEDIUM',
    category: 'section',
    sortOrder: 34,
    checklist: [
      { id: 'sec-med-db-01', check: 'Media model exists', description: 'Media model in Prisma schema' },
      { id: 'sec-med-matrix-01', check: 'Media page exists', description: '/admin/media page present' },
      { id: 'sec-med-api-01', check: 'Media API protected', description: 'Auth on upload and media routes' },
      { id: 'sec-med-ui-01', check: 'Media grid displays', description: 'Images shown as thumbnails' },
      { id: 'sec-med-state-01', check: 'Upload progress shown', description: 'Progress indicator during upload' },
      { id: 'sec-med-interact-01', check: 'Upload and delete work', description: 'File upload and media deletion functional' },
      { id: 'sec-med-responsive-01', check: 'Grid adapts to mobile', description: 'Media grid reduces columns on small screens' },
      { id: 'sec-med-a11y-01', check: 'Images have alt text', description: 'Media thumbnails are accessible' },
    ],
  },
  {
    code: 'SECTION-EMAILS',
    name: 'Emails Section Audit',
    nameFr: 'Audit Section Emails',
    description: '8-angle audit of email management: templates, newsletter campaigns',
    descriptionFr: 'Audit 8 angles des emails: gabarits, campagnes infolettre',
    severity: 'HIGH',
    category: 'section',
    sortOrder: 35,
    checklist: [
      { id: 'sec-eml-db-01', check: 'Email models exist', description: 'EmailTemplate, NewsletterCampaign, NewsletterSubscriber' },
      { id: 'sec-eml-matrix-01', check: 'Email pages exist', description: '/admin/emails and /admin/newsletter' },
      { id: 'sec-eml-api-01', check: 'Email APIs protected', description: 'Auth on email and newsletter routes' },
      { id: 'sec-eml-ui-01', check: 'Template list displays', description: 'Email templates shown with preview' },
      { id: 'sec-eml-state-01', check: 'Send confirmation', description: 'Confirmation dialog before sending campaigns' },
      { id: 'sec-eml-interact-01', check: 'Template editor works', description: 'Edit and preview email templates' },
      { id: 'sec-eml-responsive-01', check: 'Responsive layout', description: 'Email preview adapts to screen' },
      { id: 'sec-eml-a11y-01', check: 'Editor accessible', description: 'Template editor has ARIA labels' },
    ],
  },
  {
    code: 'SECTION-TELEPHONY',
    name: 'Telephony Section Audit',
    nameFr: 'Audit Section Telephonie',
    description: '8-angle audit of VoIP: extensions, call logs, IVR',
    descriptionFr: 'Audit 8 angles de la telephonie: extensions, journaux appels, SVI',
    severity: 'HIGH',
    category: 'section',
    sortOrder: 36,
    checklist: [
      { id: 'sec-tel-db-01', check: 'VoIP models exist', description: 'VoipExtension, VoipCallLog, VoipIVR' },
      { id: 'sec-tel-matrix-01', check: 'Telephony page exists', description: '/admin/telephonie page present' },
      { id: 'sec-tel-api-01', check: 'VoIP APIs protected', description: 'Auth on VoIP routes' },
      { id: 'sec-tel-ui-01', check: 'Call log displays', description: 'Call history shown with details' },
      { id: 'sec-tel-state-01', check: 'Empty state for no calls', description: 'Message when no call logs' },
      { id: 'sec-tel-interact-01', check: 'Extension management works', description: 'Create/edit VoIP extensions' },
      { id: 'sec-tel-responsive-01', check: 'Responsive call log', description: 'Call log table scrollable on mobile' },
      { id: 'sec-tel-a11y-01', check: 'Phone controls accessible', description: 'Dial pad and controls have ARIA' },
    ],
  },
  {
    code: 'SECTION-CRM',
    name: 'CRM Section Audit',
    nameFr: 'Audit Section CRM',
    description: '8-angle audit of CRM: deals, contacts, pipelines, playbooks',
    descriptionFr: 'Audit 8 angles du CRM: opportunites, contacts, pipelines, playbooks',
    severity: 'HIGH',
    category: 'section',
    sortOrder: 37,
    checklist: [
      { id: 'sec-crm-db-01', check: 'CRM models exist', description: 'CrmDeal, CrmContact, CrmPipeline, CrmPlaybook' },
      { id: 'sec-crm-matrix-01', check: 'CRM page exists', description: '/admin/crm page present' },
      { id: 'sec-crm-api-01', check: 'CRM APIs protected', description: 'Auth on CRM routes' },
      { id: 'sec-crm-ui-01', check: 'Pipeline view displays', description: 'Kanban or pipeline view shown' },
      { id: 'sec-crm-state-01', check: 'Empty pipeline state', description: 'Message when no deals in pipeline' },
      { id: 'sec-crm-interact-01', check: 'Deal drag-and-drop works', description: 'Move deals between pipeline stages' },
      { id: 'sec-crm-responsive-01', check: 'Pipeline scrollable on mobile', description: 'Kanban board scrolls horizontally' },
      { id: 'sec-crm-a11y-01', check: 'Deal cards accessible', description: 'Cards have roles and labels' },
    ],
  },
  {
    code: 'SECTION-ACCOUNTING',
    name: 'Accounting Section Audit',
    nameFr: 'Audit Section Comptabilite',
    description: '8-angle audit of accounting: journal entries, chart of accounts, fiscal, reports, invoices',
    descriptionFr: 'Audit 8 angles de la comptabilite: ecritures, plan comptable, fiscal, rapports, factures',
    severity: 'CRITICAL',
    category: 'section',
    sortOrder: 38,
    checklist: [
      { id: 'sec-acct-db-01', check: 'Accounting models exist', description: 'JournalEntry, JournalLine, ChartOfAccount, FiscalPeriod, Invoice' },
      { id: 'sec-acct-db-02', check: 'JournalLine has debit/credit', description: 'Double-entry requires debit and credit fields' },
      { id: 'sec-acct-matrix-01', check: 'Accounting pages exist', description: 'comptabilite, fiscal, rapports pages' },
      { id: 'sec-acct-api-01', check: 'Accounting APIs protected', description: 'Auth + OWNER role on sensitive routes' },
      { id: 'sec-acct-ui-01', check: 'Journal entries display', description: 'Entries shown with balanced debit/credit' },
      { id: 'sec-acct-state-01', check: 'Period lock indicator', description: 'Locked periods clearly marked' },
      { id: 'sec-acct-interact-01', check: 'Journal entry creation works', description: 'Create balanced journal entries' },
      { id: 'sec-acct-responsive-01', check: 'Reports adapt to mobile', description: 'Financial reports scrollable on small screens' },
    ],
  },
  {
    code: 'SECTION-SYSTEM',
    name: 'System Section Audit',
    nameFr: 'Audit Section Systeme',
    description: '8-angle audit of system: permissions, settings, logs, employees, backups, diagnostics, translations, SEO',
    descriptionFr: 'Audit 8 angles du systeme: permissions, parametres, logs, employes, backups, diagnostics, traductions, SEO',
    severity: 'HIGH',
    category: 'section',
    sortOrder: 39,
    checklist: [
      { id: 'sec-sys-db-01', check: 'System models exist', description: 'Permission, AuditLog, SystemSetting models' },
      { id: 'sec-sys-matrix-01', check: 'System pages exist', description: 'permissions, parametres, logs, employes, diagnostics, traductions, seo' },
      { id: 'sec-sys-api-01', check: 'System APIs require OWNER', description: 'Sensitive routes require OWNER role' },
      { id: 'sec-sys-ui-01', check: 'Settings page displays', description: 'System settings loaded and editable' },
      { id: 'sec-sys-state-01', check: 'Permission matrix displays', description: 'Role-permission grid shown' },
      { id: 'sec-sys-interact-01', check: 'Toggle permissions works', description: 'Enable/disable permissions functional' },
      { id: 'sec-sys-responsive-01', check: 'Permission grid scrollable', description: 'Large grid scrollable on mobile' },
