...
export async function seedCustomerData() {
  ...
  function getProduct(slug: string) {
    ...
    const defaultFormat = p.options.find(f => f.isDefault) || p.options[0];
    ...
    data: {
      ...
      items: {
        create: [
          {
            productId: bpc.id,
            optionId: bpcFormat?.id,
            productName: 'BPC-157',
            optionName: bpcFormat?.name || '5mg Vial',
          ...
          },
          {
            ...
            optionId: bacFormat?.id,
            productName: 'Eau Bactériostatique',
            optionName: bacFormat?.name || '10ml Vial',
          ...
          },
          {
            ...
            optionId: ipamFormat?.id,
            productName: 'Ipamorelin',
            optionName: ipamFormat?.name || '5mg Vial',
            quantity: 1,
            unitPrice: 27.00,
            total: 27.00,
          },
        ...
        create: [
          {
            ...
            optionId: healFormat?.id,
            productName: 'BPC-157 + TB-500 Blend',
            optionName: healFormat?.name || '5mg Vial',
            quantity: 2,
            unitPrice: 70.00,
            total: 140.00,
          },
          {
            productId: sema.id,
            optionId: semaFormat?.id,
            productName: 'Semaglutide',
            optionName: semaFormat?.name || '5mg Vial',
            quantity: 1,
            unitPrice: 50.00,
            total: 50.00,
          },
    ...
    data: {
      ...
      items: {
        create: [
          {
            productId: epit.id,
            optionId: epitFormat?.id,
            productName: 'Epithalon',
            optionName: epitFormat?.name || '5mg Vial',
            quantity: 2,
            unitPrice: 28.00,
            total: 56.00,
          },
          {
            productId: ghk.id,
            optionId: ghkFormat?.id,
            productName: 'GHK-Cu',
            optionName: ghkFormat?.name || '5mg Vial',
            quantity: 1,
            unitPrice: 50.00,
            total: 50.00,
          },
          {
            productId: nad.id,
            optionId: nadFormat?.id,
            productName: 'NAD+',
            optionName: nadFormat?.name || '5mg Vial',
            quantity: 1,
            unitPrice: 38.00,
            total: 38.00,
          },
    ...
    data: {
      ...
      items: {
        create: [
          ...
          {
            productId: tb500.id,
            optionId: tb500Format?.id,
            productName: 'TB-500',
            optionName: tb500Format?.name || '5mg Vial',
            quantity: 1,
            unitPrice: 40.00,
            total: 40.00,
          },
    ...
    data: {
      ...
      items: {
        create: [
          {
            productId: selank.id,
            optionId: selankFormat?.id,
            productName: 'Selank',
            optionName: selankFormat?.name || '5mg Vial',
            quantity: 2,
            unitPrice: 22.00,
            total: 44.00,
          },
          {
            productId: pt141.id,
            optionId: pt141Format?.id,
            productName: 'PT-141',
            optionName: pt141Format?.name || '5mg Vial',
            quantity: 1,
            unitPrice: 42.00,
            total: 42.00,
          },
    ...
    data: {
      ...
      items: {
        create: [
          {
            productId: nmn.id,
            optionId: nmnFormat?.id,
            productName: 'NMN',
            optionName: nmnFormat?.name || '60 Capsules',
            quantity: 1,
            unitPrice: 55.00,
            total: 55.00,
          },
