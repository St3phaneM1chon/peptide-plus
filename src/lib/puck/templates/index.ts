...
export const PAGE_TEMPLATES: PageTemplate[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      sec('process_steps', { title: 'Comment acheter', subtitle: 'Simple, rapide et sécuritaire en 4 étapes', steps: [{ icon: '🔍', title: 'Choisissez', description: 'Parcourez notre catalogue et trouvez ce qui vous convient' }, { icon: '🛒', title: 'Ajoutez au panier', description: 'Sélectionnez votre quantité et vos options' }, { icon: '💳', title: 'Payez', description: 'Paiement 100% sécurisé — carte, PayPal ou Interac' }, { icon: '📦', title: 'Livraison', description: 'Reçu à votre porte en 2 à 5 jours ouvrables' }], animation: 'slideUp' }, 4),
      sec('testimonials', { title: 'Ce que nos clients disent', items: [{ quote: 'Qualité exceptionnelle et livraison ultra rapide. Je commande exclusivement ici depuis 2 ans.', author: 'Isabelle T.', role: 'Cliente depuis 2023', rating: '5' }, { quote: 'Service client irréprochable. Mon retour a été traité en 24 heures, sans aucune discussion.', author: 'François D.', role: 'Montréal', rating: '5' }, { quote: 'Des produits conformes aux descriptions, emballage soigné. Vraiment satisfait!', author: 'Nadia R.', role: 'Québec', rating: '5' }], animation: 'fadeIn', backgroundColor: '#f8fafc' }, 5),
      sec('newsletter', { title: 'Restez informé', subtitle: '10% de rabais sur votre première commande en vous inscrivant', buttonText: 'M\'inscrire', animation: 'fadeIn', backgroundColor: '#f8fafc' }, 6),
    ],
  },
  {
  ...
  // ═══════════════════════════════════════
  {
    ...
    sections: [
      ...
      sec('testimonials', { title: 'Nos clients témoignent', items: [{ quote: 'Un accompagnement juridique de premier ordre. Leur expertise en droit des affaires nous a sauvé des années de litiges.', author: 'Jean-Pierre L.', role: 'Entrepreneur', rating: '5' }, { quote: 'Professionnels, disponibles et redoutablement efficaces. Je recommande sans hésiter.', author: 'Caroline M.', role: 'Directrice générale, PME', rating: '5' }], animation: 'fadeIn', backgroundColor: '#f8fafc' }, 4),
      sec('process_steps', { title: 'Notre approche', subtitle: 'Un processus structuré pour maximiser vos chances de succès', steps: [{ icon: '☎️', title: 'Consultation gratuite', description: 'Première rencontre pour comprendre votre situation et vos objectifs' }, { icon: '📂', title: 'Analyse du dossier', description: 'Revue exhaustive des faits, documents et enjeux juridiques' }, { icon: '⚖️', title: 'Stratégie juridique', description: 'Plan d\'action clair avec options, délais et estimation des coûts' }, { icon: '✅', title: 'Résolution', description: 'Négociation, médiation ou litige — nous défendons vos intérêts jusqu\'au bout' }], animation: 'slideUp' }, 5),
      sec('contact_form', { title: 'Demandez une consultation', subtitle: 'Première rencontre gratuite et sans engagement', animation: 'fadeIn' }, 6),
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      sec('process_steps', { title: 'Votre visite chez nous', subtitle: 'Une expérience simple et sans stress, de A à Z', steps: [{ icon: '📅', title: 'Prise de rendez-vous', description: 'En ligne, par téléphone ou par texto — disponible 24/7' }, { icon: '😊', title: 'Accueil chaleureux', description: 'Notre équipe vous reçoit dans un environnement confortable et apaisant' }, { icon: '🔍', title: 'Examen complet', description: 'Bilan de santé bucco-dentaire avec radiographies numériques' }, { icon: '📋', title: 'Plan de traitement', description: 'Options claires, coûts transparents et calendrier adapté à votre rythme' }], animation: 'slideUp' }, 4),
      sec('testimonials', { title: 'Avis de nos patients', items: [{ quote: 'Enfin un dentiste en qui j\'ai confiance! L\'équipe est douce, patiente et vraiment à l\'écoute.', author: 'Sophie R.', role: 'Patiente depuis 5 ans', rating: '5' }, { quote: 'Mon fils avait peur des dentistes. Après sa première visite ici, il demande lui-même ses rendez-vous!', author: 'Nathalie B.', role: 'Maman de 3 enfants', rating: '5' }], animation: 'fadeIn', backgroundColor: '#f0fdf4' }, 5),
      sec('cta', { title: 'Prenez soin de votre sourire', buttonText: 'Prendre rendez-vous', buttonUrl: '#', animation: 'fadeIn', backgroundColor: '#0891b2', textColor: '#ffffff' }, 6),
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      sec('testimonials', { title: 'Ce que nos clients disent', items: [{ quote: 'Travail impeccable et dans les délais. Notre maison est exactement comme on l\'avait imaginée. On recommande à tous nos proches!', author: 'Stéphanie et Patrick G.', role: 'Construction neuve — Laval', rating: '5' }, { quote: 'Rénovation complète de notre cuisine en 3 semaines. Équipe professionnelle, propre et respectueuse. Le résultat dépasse nos attentes.', author: 'Michel T.', role: 'Rénovation cuisine — Brossard', rating: '5' }], animation: 'fadeIn', backgroundColor: '#fafaf9' }, 5),
      sec('contact_form', { title: 'Demandez votre devis gratuit', subtitle: 'Réponse sous 24 heures', animation: 'fadeIn' }, 6),
    ],
  },
  // ═══════════════════════════════════════
  // BIEN-ÊTRE & BEAUTÉ
  // ═══════════════════════════════════════
  {
    ...
    sections: [
      ...
      sec('testimonials', { title: 'Ils ont vécu l\'expérience', items: [{ quote: 'Un vrai havre de paix au cœur de la ville. Le massage aux pierres chaudes était une révélation. Je repars ressourcée à chaque visite.', author: 'Amélie L.', role: 'Cliente fidèle depuis 3 ans', rating: '5' }, { quote: 'Service 5 étoiles de la réservation à la sortie. Mon soin du visage était parfaitement adapté à ma peau. Résultats visibles dès le lendemain!', author: 'Julie P.', role: 'Westmount', rating: '5' }, { quote: 'Le meilleur endroit pour se ressourcer à Montréal. Équipe attentionnée, ambiance zen, produits haut de gamme.', author: 'Catherine M.', role: 'Via Google', rating: '5' }], animation: 'fadeIn', backgroundColor: '#fdf2f8' }, 4),
      sec('newsletter', { title: 'Abonnez-vous à notre infolettre', subtitle: 'Recevez nos offres exclusives, conseils beauté et nouveautés saisonnières — 10% de rabais sur votre prochain soin à l\'inscription', buttonText: 'Je m\'inscris', animation: 'fadeIn', backgroundColor: '#fff1f2' }, 5),
      sec('cta', { title: 'Offrez-vous un moment de détente', buttonText: 'Réserver maintenant', buttonUrl: '#', animation: 'fadeIn', backgroundColor: '#be185d', textColor: '#ffffff' }, 6),
    ],
  },
  {
