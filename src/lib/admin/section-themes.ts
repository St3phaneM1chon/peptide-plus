...
export const sectionThemes: Record<AccountingSectionId, SectionTheme> = {
  ...
  entry: {
    ...
    pillText: 'text-white',
    accentBar: 'border-s-emerald-500',
  ...
  bank: {
    ...
    navIcon: 'text-teal-600',
    navChevron: 'text-teal-500',
    pillBg: 'bg-teal-600',
    pillText: 'text-white',
    accentBar: 'border-s-teal-500',
