...
import {
  ...
  BookOpen, Import, Ruler, Scale, Calendar, CalendarDays, FileCheck, Zap, Target,
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/admin/evenements', labelKey: 'admin.nav.events', icon: CalendarDays },
          ...
          { href: '/admin/dropshipping', labelKey: 'admin.nav.dropshipping', icon: Truck },
        ],
        defaultOpen: true,
      },
      {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/admin/affilies', labelKey: 'admin.nav.affiliateLinks', icon: Link2 },
      ...
      {
        labelKey: 'admin.nav.socialCommerce',
        items: [
          { href: '/admin/social-commerce', labelKey: 'admin.nav.socialCommerceOverview', icon: Share2 },
        ],
        collapsible: true,
        defaultOpen: false,
      },
      ...
      },
      {
        ...
        items: [
          { href: '/admin/personnalisation', labelKey: 'admin.nav.personalization', icon: Target },
          { href: '/admin/automatisations', labelKey: 'admin.nav.automations', icon: Workflow },
        ],
        collapsible: true,
        defaultOpen: true,
      },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/admin/media/sessions', labelKey: 'admin.nav.videoSessions', icon: Video },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: '/admin/performance', labelKey: 'admin.nav.performance', icon: Activity },
...
export function getActiveRailId(pathname: string): string {
  ...
  if (pathname.startsWith('/admin/commandes') || pathname.startsWith('/admin/customers') || pathname.startsWith('/admin/clients') || pathname.startsWith('/admin/abonnements') || pathname.startsWith('/admin/inventaire') || pathname.startsWith('/admin/fournisseurs') || pathname.startsWith('/admin/produits') || pathname.startsWith('/admin/categories') || pathname.startsWith('/admin/bundles') || pathname.startsWith('/admin/avis') || pathname.startsWith('/admin/questions') || pathname.startsWith('/admin/livraison') || pathname.startsWith('/admin/retours') || pathname.startsWith('/admin/bnpl') || pathname.startsWith('/admin/tarifs-transporteurs') || pathname.startsWith('/admin/dropshipping') || pathname.startsWith('/admin/evenements') || pathname.startsWith('/admin/reservations')) return 'commerce';
  if (pathname.startsWith('/admin/promo-codes') || pathname.startsWith('/admin/promotions') || pathname.startsWith('/admin/upsell') || pathname.startsWith('/admin/ambassadeurs') || pathname.startsWith('/admin/affilies') || pathname.startsWith('/admin/fidelite') || pathname.startsWith('/admin/membership') || pathname.startsWith('/admin/ab-tests') || pathname.startsWith('/admin/social-commerce') || pathname.startsWith('/admin/personnalisation') || pathname.startsWith('/admin/automatisations')) return 'marketing';
  if (pathname.startsWith('/admin/media') || pathname.startsWith('/admin/webinaires')) return 'media';
  if (pathname.startsWith('/admin/rapports') || pathname.startsWith('/admin/analytics')) return 'dashboard';
  if (pathname.startsWith('/admin/logs') || pathname.startsWith('/admin/uat') || pathname.startsWith('/admin/diagnostics') || pathname.startsWith('/admin/navigateur') || pathname.startsWith('/admin/mots-magiques') || pathname.startsWith('/admin/audits') || pathname.startsWith('/admin/backups') || pathname.startsWith('/admin/monitoring') || pathname.startsWith('/admin/performance') || pathname.startsWith('/admin/system/crons')) return 'dev';
  ...
  if (pathname.startsWith('/admin/permissions') || pathname.startsWith('/admin/employes') || pathname.startsWith('/admin/parametres') || pathname.startsWith('/admin/devises') || pathname.startsWith('/admin/traductions') || pathname.startsWith('/admin/traduction-auto') || pathname.startsWith('/admin/webhooks') || pathname.startsWith('/admin/integrations') || pathname.startsWith('/admin/securite') || pathname.startsWith('/admin/tutoriels') || pathname.startsWith('/admin/modules')) return 'system';
  return 'dashboard';
}
