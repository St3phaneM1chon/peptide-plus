...
const NAV_ITEMS = [
  { href: '/mobile/dashboard', icon: LayoutDashboard, key: 'mobile.nav.dashboard' },
  { href: '/mobile/expenses', icon: Receipt, key: 'mobile.nav.expenses' },
  { href: '/mobile/receipt-capture', icon: Camera, key: 'mobile.nav.capture' },
  { href: '/mobile/time-tracker', icon: Clock, key: 'mobile.nav.timer' },
  { href: '/mobile/settings', icon: Settings, key: 'mobile.nav.more' },
];
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      {!online && (
        <div className="bg-amber-500 text-white text-center text-sm py-1.5 px-4 font-medium">
          {t('mobile.offline.banner')} — {t('mobile.offline.syncMessage')}
        </div>
      )}

      {/* Header */}
      <header className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between sticky top-0 z-40">
        <h1 className="text-lg font-bold text-purple-700">{t('mobile.header')}</h1>
