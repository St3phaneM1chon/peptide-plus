...
export const metadata: Metadata = {
  title: 'Programme partenaires et revendeurs produits | Koraline',
  description: 'Devenez partenaire Koraline. Programme d\'affiliation, revendeurs agrees et distributeurs de produits au Canada et a l\'international.',
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_APP_URL || 'https://attitudes.vip'}/solutions/partenaires`,
  },
  openGraph: {
    title: 'Programme partenaires et revendeurs produits | Koraline',
    description: 'Devenez partenaire Koraline. Programme d\'affiliation, revendeurs agrees et distributeurs de produits.',
