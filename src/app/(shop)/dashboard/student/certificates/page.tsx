...
export default function StudentCertificatesPage() {
 ...
 <div className="h-8 w-64 bg-[var(--k-glass-thin)] rounded" />
 <div className="h-4 w-96 bg-[var(--k-glass-thin)] rounded" />
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
 {[1, 2, 3].map((i) => (
 <div key={i} className="h-64 bg-[var(--k-glass-thin)] rounded-2xl" />
 ))}
 </div>
 </div>
 </div>
 ...
 ${isSelected
 ? 'bg-gradient-to-r from-[#6366f1] to-[#818cf8] text-white shadow-sm'
 : 'bg-[var(--k-glass-thin)] text-[var(--k-text-secondary)] hover:bg-[var(--k-glass-regular)] border border-[var(--k-border-subtle)] '
 }
 `}
 >
 ...
 <div className="mx-auto w-20 h-20 rounded-full bg-[var(--k-glass-thin)] flex items-center justify-center mb-6">
 <svg
 className="w-10 h-10 text-[var(--k-text-tertiary)] "
 fill="none"
 viewBox="0 0 24 24"
 stroke="currentColor"
 strokeWidth={1.5}
 ...
 <p className="text-[var(--k-text-secondary)] max-w-md mx-auto">
 {filter === 'all'
 ...
 <div
 key={cert.id}
 className="bg-[var(--k-glass-regular)] backdrop-blur-xl rounded-2xl border border-[var(--k-border-subtle)] shadow-[var(--k-shadow-md)] overflow-hidden hover:shadow-[var(--k-shadow-lg)] transition-shadow"
 >
 {/* Thumbnail / Header */}
 ...
 {cert.qrCodeUrl && (
 <div
 className="absolute top-3 left-3 w-8 h-8 bg-[var(--k-glass-thin)] backdrop-blur-sm rounded-lg flex items-center justify-center"
 ...
 <div className="p-5">
 <h3
 className="text-lg font-semibold text-[var(--k-text-primary)] mb-3 line-clamp-2"
 title={cert.courseTitle}
 >
 {cert.courseTitle}
 </h3>

 <div className="space-y-2 text-sm text-[var(--k-text-secondary)] ">
 {/* Issue date */}
 ...
 <span
 className="font-mono text-xs bg-[var(--k-glass-thin)] px-2 py-0.5 rounded select-all"
 ...
 {/* Actions */}
 <div className="mt-4 pt-4 border-t border-[var(--k-border-subtle)] flex items-center gap-2">
 {/* Download PDF */}
 <button
 onClick={() => handleDownload(cert.id)}
 className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium rounded-xl bg-blue-50 text-blue-700 dark:text-[var(--k-text-tertiary)] hover:bg-blue-100 transition-colors"
 ...
 className="flex items-center justify-center w-10 h-10 rounded-xl bg-[var(--k-glass-thin)] text-[var(--k-text-secondary)] hover:bg-[var(--k-glass-thin)] transition-colors"
