...
const domainColors: Record<string, string> = {
 conformite: 'bg-blue-100 text-[var(--k-accent-indigo)]',
 ...
 general: 'bg-[var(--k-glass-thin)] text-gray-800',
...
export default function GlossairePage() {
 ...
 {/* Hero */}
 <section className="bg-[var(--k-bg-surface)] border-b border-[var(--k-border-subtle)] text-white py-12 md:py-16">
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
 <Link
 href="/learn"
 className="inline-flex items-center text-sm text-[var(--k-text-secondary)] hover:text-white mb-4 transition-colors"
 >
 ...
 <p className="text-lg text-[var(--k-text-secondary)] max-w-2xl mx-auto">
 ...
 {/* Search & Filters */}
 <div className="bg-[var(--k-glass-regular)] backdrop-blur-xl rounded-xl border border-[var(--k-border-subtle)] shadow-[var(--k-shadow-md)] p-4 md:p-6 mb-6 sticky top-20 z-10">
 {/* Search bar */}
 <div className="relative mb-4">
 <svg
 className="absolute left-3 rtl:left-auto rtl:right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[var(--k-text-tertiary)]"
 fill="none"
 stroke="currentColor"
 viewBox="0 0 24 24"
 >
 ...
 className="w-full pl-10 rtl:pl-4 rtl:pr-10 pr-4 py-3 border border-gray-200 rounded-lg text-[var(--k-text-primary)] placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
 />
 {search && (
 <button
 onClick={() => setSearch('')}
 className="absolute right-3 rtl:right-auto rtl:left-3 top-1/2 -translate-y-1/2 text-[var(--k-text-tertiary)] hover:text-[var(--k-text-secondary)]"
 >
 ...
 : isAvailable
 ? 'bg-[var(--k-glass-thin)] text-[var(--k-text-secondary)] hover:bg-blue-100 hover:text-blue-700'
 : 'bg-[var(--k-glass-ultra-thin)] text-[var(--k-text-tertiary)] cursor-not-allowed'
 }`}
 >
 {letter}
 </button>
 ...
 <span className="text-xs text-[var(--k-text-secondary)] font-medium self-center mr-1">{t('learn.glossary.filterByManual')}:</span>
 {manualFilters.map((m) => (
 <button
 key={m.key}
 ...
 ? 'bg-gradient-to-r from-[#6366f1] to-[#818cf8] text-white'
 : 'bg-[var(--k-glass-thin)] text-[var(--k-text-secondary)] hover:bg-gray-200'
 }`}
 >
 {d.label}
 </button>
 ...
 <div className="bg-[var(--k-glass-regular)] backdrop-blur-xl rounded-xl border border-[var(--k-border-subtle)] shadow-[var(--k-shadow-md)] p-12 text-center">
 <div className="text-5xl mb-4">
 <svg className="w-16 h-16 mx-auto text-[var(--k-text-tertiary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
 </svg>
 </div>
 <h3 className="text-lg font-semibold text-[var(--k-text-primary)] mb-1">
 ...
 <span className="w-10 h-10 flex items-center justify-center bg-gradient-to-r from-[#6366f1] to-[#818cf8] text-white font-bold text-lg rounded-lg">
 {letter}
 </span>
 <div className="flex-1 h-px bg-[var(--k-glass-thin)]" />
 ...
 <div
 key={term.id}
 className={`bg-[var(--k-glass-regular)] backdrop-blur-xl rounded-xl border border-[var(--k-border-subtle)] shadow-[var(--k-shadow-md)] overflow-hidden transition-all duration-200 ${
 isExpanded ? 'ring-2 ring-blue-200' : 'hover:shadow-[var(--k-shadow-lg)]'
 }`}
 >
 {/* Collapsed view */}
 <button
 ...
 <h3 className="font-semibold text-[var(--k-text-primary)]">{term.term}</h3>
 ...
 <p className="text-sm text-[var(--k-text-secondary)] line-clamp-2">
 {term.shortDef}
 </p>
 </div>
 <svg
 className={`w-5 h-5 text-[var(--k-text-tertiary)] flex-shrink-0 mt-1 transition-transform duration-200 ${
 ...
 {/* Expanded view */}
 {isExpanded && (
 <div className="px-5 pb-5 border-t border-[var(--k-border-subtle)] pt-4">
 <p className="text-[var(--k-text-secondary)] leading-relaxed mb-4">
 {term.fullDef}
 </p>
 ...
 <div className="mb-4">
 <h4 className="text-xs font-semibold text-[var(--k-text-secondary)] uppercase tracking-wider mb-2">
 ...
 className="inline-flex items-center gap-2 px-4 py-2 text-sm text-[var(--k-text-secondary)] hover:text-[var(--k-text-secondary)] transition-colors"
 >
 <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
