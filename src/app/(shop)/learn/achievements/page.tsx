...
const allBadges: Badge[] = [
 ...
 { id: 'tenCourses', category: 'course', iconPath: 'M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5', criteria: 10, color: 'text-[var(--k-accent-indigo)]', bgColor: 'bg-blue-200' },
...
export default function AchievementsPage() {
 ...
 <div className="bg-[var(--k-glass-regular)] backdrop-blur-xl rounded-xl border border-[var(--k-border-subtle)] shadow-[var(--k-shadow-md)] p-5 text-center">
 <div className="text-3xl font-bold text-[var(--k-accent-indigo)]">{userProgress.totalPoints}</div>
 <div className="text-sm text-[var(--k-text-secondary)] mt-1">{t('learn.achievements.totalPoints')}</div>
 </div>
 <div className="bg-[var(--k-glass-regular)] backdrop-blur-xl rounded-xl border border-[var(--k-border-subtle)] shadow-[var(--k-shadow-md)] p-5 text-center">
 <div className="text-3xl font-bold text-green-600">{earnedCount}/{totalCount}</div>
 <div className="text-sm text-[var(--k-text-secondary)] mt-1">{t('learn.achievements.badgesEarned')}</div>
 </div>
 <div className="bg-[var(--k-glass-regular)] backdrop-blur-xl rounded-xl border border-[var(--k-border-subtle)] shadow-[var(--k-shadow-md)] p-5 text-center">
 <div className="text-3xl font-bold text-orange-600">{userProgress.currentStreak}</div>
 <div className="text-sm text-[var(--k-text-secondary)] mt-1">{t('learn.achievements.currentStreak')}</div>
 </div>
 <div className="bg-[var(--k-glass-regular)] backdrop-blur-xl rounded-xl border border-[var(--k-border-subtle)] shadow-[var(--k-shadow-md)] p-5 text-center">
 <div className="text-3xl font-bold text-purple-600">{userProgress.hoursStudied}h</div>
 <div className="text-sm text-[var(--k-text-secondary)] mt-1">{t('learn.achievements.hoursStudied')}</div>
 </div>
 </div>

 {/* Progress bar overall */}
 <div className="bg-[var(--k-glass-regular)] backdrop-blur-xl rounded-xl border border-[var(--k-border-subtle)] shadow-[var(--k-shadow-md)] p-6 mb-8">
 <div className="flex items-center justify-between mb-2">
 <h3 className="font-semibold text-[var(--k-text-primary)]">{t('learn.achievements.overallProgress')}</h3>
 <span className="text-sm text-[var(--k-text-secondary)]">{Math.round((earnedCount / totalCount) * 100)}%</span>
 </div>
 <div className="w-full h-3 bg-[var(--k-glass-thin)] rounded-full overflow-hidden">
 <div
 ...
 <div
 key={badge.id}
 className={`bg-[var(--k-glass-regular)] backdrop-blur-xl rounded-xl border border-[var(--k-border-subtle)] shadow-[var(--k-shadow-md)] overflow-hidden transition-all ${
 isEarned ? 'ring-2 ring-blue-200 hover:shadow-[var(--k-shadow-lg)]' : 'opacity-75 hover:opacity-100'
 }`}
 >
 ...
 <svg className="w-6 h-6 text-[var(--k-text-tertiary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <span className="text-xs text-[var(--k-text-tertiary)]">{progressPct}%</span>
 </div>
 <div className="w-full h-1.5 bg-[var(--k-glass-thin)] rounded-full overflow-hidden">
 <div
 ...
 <div className="bg-[var(--k-glass-regular)] backdrop-blur-xl rounded-xl border border-[var(--k-border-subtle)] shadow-[var(--k-shadow-md)] overflow-hidden">
 ...
 : 'bg-[var(--k-glass-thin)] text-gray-500'
 }`}>
 {idx + 1}
 </div>
 <div className="flex-1">
 <h3 className="font-semibold text-[var(--k-text-primary)] text-sm">
 ...
 <span className="font-bold text-[var(--k-text-primary)]">{team.points.toLocaleString()}</span>
 <span className="text-xs text-[var(--k-text-secondary)] ml-1">{t('learn.achievements.pts')}</span>
 </div>
 </div>
 ))}
 </div>
 ...
 {/* Share / CTA */}
 <section className="bg-gradient-to-r from-[#6366f1] to-[#06b6d4] rounded-2xl p-8 md:p-12 text-white text-center">
 ...
 className="px-8 py-3 bg-white text-[#6366f1] font-semibold rounded-lg hover:bg-white/90 transition-colors"
 >
