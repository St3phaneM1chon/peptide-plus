...
const RATING_CONFIG: Record<Rating, { color: string; bg: string; border: string; hoverBg: string }> = {
  1: { color: 'text-red-700', bg: 'bg-red-50', border: 'border-red-200', hoverBg: 'hover:bg-red-100' },
  2: { color: 'text-orange-700', bg: 'bg-orange-50', border: 'border-orange-200', hoverBg: 'hover:bg-orange-100' },
  3: { color: 'text-green-700', bg: 'bg-green-50', border: 'border-green-200', hoverBg: 'hover:bg-green-100' },
  4: { color: 'text-blue-700', bg: 'bg-blue-50', border: 'border-blue-200', hoverBg: 'hover:bg-blue-100' },
};
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-sm text-gray-500">{t('learn.review.loading')}</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-[#143C78] text-white py-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link
            href="/learn"
            className="inline-flex items-center gap-2 text-blue-300 hover:text-blue-200 mb-5 text-sm"
          >
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!sessionComplete && totalDue === 0 && (
          <div className="text-center py-16">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <Link
                href="/learn"
                className="px-5 py-2.5 bg-white text-gray-700 font-medium rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors text-sm"
              >
                {t('learn.backToLearning')}
              </Link>
            </div>
        ...
        {!sessionComplete && totalDue > 0 && currentItem && (
          <div className="space-y-6">
            ...
            <div className="hidden sm:flex items-center justify-center gap-4 text-xs text-gray-400 mt-4">
...
function SessionSummary({
  ...
  return (
    <div className="max-w-2xl mx-auto text-center py-8">
      ...
      {/* Results list */}
      <div className="bg-white rounded-xl border border-gray-200 divide-y divide-gray-100 text-left mb-6">
        {results.map((result, i) => {
          const cfg = RATING_CONFIG[result.rating];
          return (
            <div key={i} className="flex items-center justify-between px-4 py-3">
              <span className="text-sm text-gray-700 font-medium">{result.conceptName}</span>
