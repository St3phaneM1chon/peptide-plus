  ...
  const orderColumns: Column<RecentOrderItem>[] = [
    {
      ...
      render: (row) => <span className="font-medium text-indigo-600">{row.id}</span>,
    },
    {
      key: 'date',
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Button variant="secondary" icon={FileText} className="bg-indigo-500 text-white hover:bg-indigo-600 border-transparent">
