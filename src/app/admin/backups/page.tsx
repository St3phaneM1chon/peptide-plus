...
export default function BackupsPage() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto" role="main" aria-label={t('admin.backups.title')}>
      <PageHeader
              ...
              return (
                <div key={key} className="bg-[var(--k-glass-thin)] rounded-xl border border-[var(--k-border-subtle)] shadow-sm overflow-hidden">
                  ...
                  >
                    ...
                    <div className="text-end text-sm space-y-0.5 flex-shrink-0">
                    ...
                    <div className="text-slate-400 ms-2">
                          ...
                          <div className="bg-[var(--k-glass-thin)] rounded-lg border border-[var(--k-border-subtle)] p-3 text-sm">
                            {verification.valid ? (
                              <div className="flex items-center gap-2 text-emerald-700">
                                ...
                                {verification.sha256 && (
                                  <span className="text-xs font-mono text-slate-400 ms-2">SHA256: {verification.sha256}</span>
                                )}
                              </div>
                            ) : (
                                ...
                                <tr key={i} className="hover:bg-white/5">
                                  ...
                                  <td className="px-3 py-2">
                                    <span className={`inline-flex px-2 py-0.5 rounded text-xs font-medium ${
                                      ...
                                      v.type === 'azure' ? 'bg-indigo-100 text-indigo-700' :
                                      'bg-slate-100 text-slate-600'
                                    }`}>
                                      {v.type === 'azure' && <Cloud className="w-3 h-3 me-1" />}
                                      {v.type}
                                    </span>
                                  </td>
          ...
          <div className="mt-6 bg-[var(--k-glass-thin)] rounded-xl border border-[var(--k-border-subtle)] shadow-sm p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
              {[
                ...
                { time: '04:15', label: 'Peptide-Plus - Snapshot code source', color: 'bg-indigo-100 text-indigo-700' },
