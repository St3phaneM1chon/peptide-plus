  ...
  const warehouseColumns: Column<WarehouseData>[] = [
    {
      ...
      render: (row) => (
        <div>
          ...
          {row.isDefault && (
            <span className="ms-2 text-xs bg-indigo-100 text-indigo-800 px-2 py-0.5 rounded">{t('admin.inventory.adv.default')}</span>
          )}
        </div>
      ),
    },
    ...
    },
    {
      ...
      render: (row) => (
        <div className="flex gap-2">
          <button onClick={() => openEditWarehouse(row)} className="text-indigo-600 hover:text-indigo-800">
          ...
          <div className="space-y-4 max-h-[70vh] overflow-y-auto">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button onClick={addTransferItem} className="text-indigo-600 text-sm hover:underline flex items-center gap-1">
