    ...
    <div className="p-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            <FileInput className="h-6 w-6 text-indigo-600" />
            {t('admin.crm.webForms')}
          </h1>
      ...
      {showCreate && (
        <div className="bg-[var(--k-glass-thin)] border rounded-xl p-6 mb-6">
          ...
          <button onClick={handleCreate} className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm">
            Create Form
          </button>
        </div>
      )}
