...
export default function WorkflowAnalyticsClient() {
  const { t } = useI18n();
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              {t('admin.crm.workflowAnalytics')}
            </h1>
            <p className="text-sm text-gray-500 mt-0.5">
              {t('admin.crm.workflowAnalyticsDesc')}
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-[var(--k-glass-thin)] rounded-lg border border-gray-200 p-4">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-medium text-gray-500 uppercase">
                  {t('admin.crm.avgDuration')}
                </span>
              </div>
              <p className="text-2xl font-bold text-indigo-600">{formatDuration(s.avgDurationMs)}</p>
                  ...
                  {(data?.byWorkflow ?? []).length === 0 ? (
                    ...
                    (data?.byWorkflow ?? []).map(w => (
                      <tr key={w.workflowId} className="border-b border-gray-50 hover:bg-gray-50">
                        ...
                        <td className="px-4 py-2.5 text-center text-indigo-600">{w.running}</td>
