  ...
  return (
    <div className="min-h-[40vh] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full text-center">
        <div className="mx-auto w-14 h-14 bg-red-500/10 rounded-full flex items-center justify-center mb-5">
        ...
        <p className="text-[var(--k-text-secondary)] mb-4 text-sm">
        ...
        <button
          onClick={reset}
          className="px-5 py-2.5 bg-gradient-to-r from-[#6366f1] to-[#818cf8] text-white rounded-lg font-medium hover:opacity-90 transition-opacity"
