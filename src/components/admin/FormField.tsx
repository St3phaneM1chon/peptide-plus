...
export function FormField({ label, htmlFor, required, error, hint, children }: FormFieldProps) {
  ...
  return (
    <div className="space-y-1.5" aria-describedby={error && errorId ? errorId : undefined}>
  ...
  return (
    <input
      className={`
        ...
        focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:border-indigo-700
