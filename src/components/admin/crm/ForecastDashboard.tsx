        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none ps-3 pe-8 py-1.5 text-sm border border-gray-200 rounded-lg bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
              ...
              <>
                    ...
                    return (
                      <div key={f.month} className="flex-1 flex flex-col items-center group">
                        ...
                        <div className="w-full relative flex items-end gap-px h-32">
                          <div
                            className="flex-1 bg-indigo-100 rounded-t transition-all"
                            style={{ height: `${totalH}%` }}
                ...
                <div className="flex items-center gap-5 text-xs text-gray-500 mb-5">
                  <span className="flex items-center gap-1.5">
                    <span className="w-3 h-3 bg-indigo-100 rounded-sm inline-block" />
                    ...
                    <tbody className="divide-y divide-gray-50">
                      {data.timeline.map(f => (
                        <tr key={f.month} className="hover:bg-gray-50">
                          ...
                          <td className="py-2 text-end text-indigo-600 font-medium">{fmt(f.weightedValue)}</td>
                    ...
                    <tbody className="divide-y divide-gray-50">
                      {data.byPipeline.map(row => (
                        <tr key={row.pipelineId} className="hover:bg-gray-50">
                          ...
                          <td className="py-2 text-end text-indigo-600 font-medium">{fmt(row.weighted)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
