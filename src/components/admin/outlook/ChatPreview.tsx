  ...
  return (
    <div className="border-t border-slate-200 flex flex-col" style={{ maxHeight: '35%' }}>
      ...
      <div className="flex items-center gap-2 px-3 py-2 bg-slate-50 border-b border-slate-100 flex-shrink-0">
        ...
        {chats.length > 0 && (
          <span className="ms-auto text-xs bg-indigo-100 text-indigo-700 rounded-full px-1.5 py-0.5 font-medium">
            {chats.length}
          </span>
        )}
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          <div className="p-3 text-center">
            <div
              className="animate-spin w-4 h-4 border-2 border-slate-300 border-t-indigo-600 rounded-full mx-auto"
              role="status"
            >
