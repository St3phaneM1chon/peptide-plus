...
export function CategoryCard({ category }: CategoryCardProps) {
  return (
    ...
    >
      ...
      {/* Icône flèche */}
      <div className="absolute top-4 end-4 w-8 h-8 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
        <svg
